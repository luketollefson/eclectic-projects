...
;; make-product that simplifies (* a 1) and (* a 0)
...
;; make-exponentiation that simplifies
(define (make-exponentiation b e)
  (cond ((=number? b 0) 0)
        ((=number? b 1) 1)
        ((=number? e 0) 1)
        ((=number? e 1) b)
        ((and (number? b) (number? e) (expt 2 4)))
        (else (list '** b e))))
